...
# Import EduCortex components
from backend import EduCortexOrchestrator, EduCortexMemory
...
def main():
    ...
    print("Running queries through EduCortex pipeline...")
